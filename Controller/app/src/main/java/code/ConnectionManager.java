...
public class ConnectionManager {
    ...
    private synchronized void setState(int state) {
        if (D) Log.d(LogTag, "setState() " + mState + " -> " + state);
        mState = state;
    ...
    public synchronized void connect(BluetoothDevice device) {
        if (D) Log.d(LogTag, "connect to: " + device);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                tmp = device.createRfcommSocketToServiceRecord(SerialPortService_UUID);
            } catch (IOException e) {
                Log.e(LogTag, "create() failed", e);
            }
            mmSocket = tmp;
        }

        public void run() {
            Log.i(LogTag, "BEGIN mConnectThread");
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            try {
                ...
                Log.e(LogTag, "temp sockets not created", e);
            }
